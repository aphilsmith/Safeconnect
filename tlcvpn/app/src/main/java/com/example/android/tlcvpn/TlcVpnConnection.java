...
public class TlcVpnConnection implements Runnable {
    /**
     * Callback interface to let the {@link TlcVpnService} know about new connections
    ...
    public TlcVpnConnection(final VpnService service, final int connectionId,
    ...
    private final String getTag() {
        return TlcVpnConnection.class.getSimpleName() + "[" + mConnectionId + "]";
    }
}
