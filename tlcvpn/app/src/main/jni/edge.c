...
jstring
Java_com_example_android_tlcvpn_TlcVpnClient_stringFromJNI( JNIEnv* env,
                                                  jobject thiz )
{
#if defined(__arm__)
...
#define ABI "unknown"
#endif
    char arr[] = {"-d", "tun0", "-a", "10.0.1.225", "-s", "255.255.0.0", "-c", "tlcnet", "-k", "mysecret", "-u", "1000", "-g", "1000", "-m", "fe80::ec88:8308:73e4:1da%15",  "tlcsupernode.ddns.net:5000", "-r"};
    int res = main(9, arr);
